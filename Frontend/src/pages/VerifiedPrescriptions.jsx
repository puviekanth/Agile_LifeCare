...
const DeliveryDetails = () => {
  ...
  const fetchDeliveries = async () => {
    try {
      ...
      const res = await fetch(`${api}/api/verifiedprescriptions`, {
        headers: {
  ...
  return (
    <>
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-10">
        <h2 className="text-3xl font-bold text-center mb-6 text-blue-800 tracking-tight">Verified Prescriptions</h2>
